...
;RUP *=*+$40 ;UP ROOMS
;RDOWN *=*+$40 ;DOWN ROOMS
;VERBS *=*+$100 ;LIST OF VERBS
;NOUNS *=*+$100 ;LIST OF NOUNS
;GETT *=*+$100 ;LIST OF LIFTABLE OBJECTS
;SENMAT *=*+$B00 ;SENTENCE MATRIX
;ITEMT *=*+$580 ;TEXT OF ITEMS
;ROOMT *=*+$600 ;TEXT OF ROOMS
;MESGT *=*+$900 ;MESSAGE TEXT
;IL *=*+$50 ;ITEM TABLE
;PERCT *=*+$20 ;SCORE TABLE FOR TREASUURES
;MX *=*+1 ;MAXIMUM ITEM NUMBER
;LN *=*+1 ;INITIAL TURNS OF LIGHT
;TT *=*+1 ;NUMBER OF TREASURES
;RL *=*+1 ;LIMBO ROOM
;AR *=*+1 ;STARTING ROOM
;ILN *=*+1 ;NUMBER OF ITEMS-1
;TR *=*+1 ;STORAGE ROOM FOR TREASURES
...
SF *=*+2
L *=*+1 ;DARK MOVEMENT FLAG
ROOM *=*+1 ;CURRENT ROOM NUMBER
DF *=*+1 ;$FF = DARK $00 = LIGHT
LX *=*+1 ;TURNS OF LIGHT LEFT
EXITS *=*+6 ;EXITS FROM CURRENT ROOM
K *=*+1 ;GENERAL PURPOSE FLAG
F *=*+1
F1 *=*+1
F2 *=*+1
F3 *=*+1 ;OPERATION FLAGS
LL *=*+1 ;TESTING FUNCTION DATA
IP *=*+1 ;DATA POINTER
PD *=*+1 ;EXECUTION FUNCTION DATA
RANDOM *=*+1 ;RANDOM NUMBER POINTER
I2 *=*+$50 ;ORIGINAL ROOM MATRIX SAVED
STRING *=*+5 ;STRING BUFFER
INTGER *=*+1 ;PLACE TO KEEP NUMBER
.OPT NOL
 ;ADVENTURE SHELL
 ;MAIN PROGRAM
...
MSGA .BYT CLS,'          ',RVSON
 ...
 .BYT 'FIND TREASURES AND RETURN THEM TO THEIR',CR
...
IP006 JSR STROUT
 ...
 RTS
; DIRECTIONS
DIRS .WOR NORTH,SOUTH,EAST,WEST,UP,DOWN
NORTH .BYT 'NORTH ',$0
SOUTH .BYT 'SOUTH ',$0
EAST .BYT 'EAST ',$0
WEST .BYT 'WEST ',$0
...
DOWN .BYT 'DOWN ',$0
; ERROR MESSAGES
PROMPT .BYT $8D,$11,$D7,'HAT NOW? ',$00
IMTXT .BYT $C9,$27,$CD,$20,$C9,$CE,$20,$C1,$20,0
DRKTXT .BYT $C9,'T''S TOO DARK TO SEE.',0
NLITE .BYT $CC,'IGHT HAS RUN OUT!',0
ALITE .BYT $CC,'IGHT RUNS OUT IN ',0
BLITE .BYT ' TURNS.',CR,0
DKNOW .BYT $D9,'OU USE WORDS ',$C9,' DON''T KNOW.',CR,0
NDIR .BYT $8D,$C7,'IVE ME A DIRECTION TOO.',CR,0
TDARK .BYT $C9,'T''S DANGEROUS IN THE DARK.',CR,0
BNECK .BYT $C9,' FELL DOWN AND BROKE MY NECK.',0
NOWAY .BYT $C9,' CAN''T GO IN THAT DIRECTION!',0
NUNDER .BYT $C9,' DON''T UNDERSTAND YOUR COMMAND.',CR,0
NOTYET .BYT $C9,' CAN''T DO THAT...YET.',CR,0
OK .BYT 'OK, ',CR,CR,0
WHAT .BYT 'WHAT?',CR,0
TOMUCH .BYT $C9,'''VE TOO MUCH TO CARRY!',CR,0
DHAVE .BYT $C9,'''M NOT CARRYING IT!',CR,0
NHERE .BYT $C9,' DON''T SEE IT HERE.',CR,0
CTDO .BYT $C9,'T''S BEYOND BY POWER TO DO THAT.',CR,0
DEAD ;HE DOOD IT
 .BYT $C9,'''M DEAD.',CR,0
WAYOUT .BYT $8D,$CF,$C2,$D6,$C9,$CF,$D5,$D3
 .BYT $20,$C5,$D8,$C9,$D4,$D3,$3A,$8D
 .BYT $00
VHERE .BYT $8D,$11,$D6,$C9,$D3,$C9,$C2,$CC
 .BYT $C5,$20,$C9,$D4,$C5,$CD,$D3,$20
 .BYT $C8,$C5,$D2,$C5,$3A,$20,$8D,$00
GOVER .BYT CR,$D4,'HE GAME IS NOW OVER.-',$C1,'NOTHER GAME? ',0
 ISTRD .BYT $C9,'''VE STORED',0
 TRSRS .BYT 'TREASURES. ',$CF,'ON A SCALE'
 .BYT CR,'OF 0 TO 100 THAT RATES A',CR,0
DONE .BYT $D7,$C5,$CC,$CC,$20,$C4,$CF,$CE,$C5,CR,0
; CALCULATION TABLES
THREE ;DIVIDE BY 3 TABLE (0-192)
 .BYT 00,00,00,01,01,01,02,02
 .BYT 02,03,03,03,04,04,04,05
 .BYT 05,05,06,06,06,07,07,07
 .BYT 08,08,08,09,09,09,10,10
 .BYT 10,11,11,11,12,12,12,13
 .BYT 13,13,14,14,14,15,15,15
 .BYT 16,16,16,17,17,17,18,18
 .BYT 18,19,19,19,20,20,20,21
 .BYT 21,21,22,22,22,23,23,23
 .BYT 24,24,24,25,25,25,26,26
 .BYT 26,27,27,27,28,28,28,29
 .BYT 29,29,30,30,30,31,31,31
 .BYT 32,32,32,33,33,33,34,34
 .BYT 34,35,35,35,36,36,36,37
 .BYT 37,37,38,38,38,39,39,39
 .BYT 40,40,40,41,41,41,42,42
 .BYT 42,43,43,43,44,44,44,45
 .BYT 45,45,46,46,46,47,47,47
 .BYT 48,48,48,49,49,49,50,50
 .BYT 50,51,51,51,52,52,52,53
 .BYT 53,53,54,54,54,55,55,55
 .BYT 56,56,56,57,57,57,58,58
 .BYT 58,59,59,59,60,60,60,61
 .BYT 61,61,62,62,62,63,63,63
TWO ;POWERS OF TWO
 .DBY $0001,$0002,$0004,$0008
 .DBY $0010,$0020,$0040,$0080
 .DBY $0100,$0200,$0400,$0800
 .DBY $1000,$2000,$4000,$8000
TEN ;POWERS OF TEN
 .BYT 100,10,1
TJUMP ;JUMP TABLE FOR TESTING FUNCTIONS
 .WOR BL1060-1 ;NULL OPERATION
 .WOR BL940,BL960,BL980,BL1000
 .WOR BL1010,BL1020,BL1030,BL1040
 .WOR BL1050,BL900,BL920,BL950
 .WOR BL970,BL990
EJUMP ;JUMP TABLE FOR EXECUTION FUNCTIONS
 .WOR BL1290,BL1330,BL1340,BL1360
 .WOR BL1370,BL1380,BL1390,BL1360
 .WOR BL1410,BL1430,BL1440,BL1450
 .WOR BL1470,BL1480,BL1530,BL1570
 .WOR BL1580,BL1590,BL1600,BL2020
 .WOR BL1350
NUMBER
 .BYT 47,19,9,82,64,50,27,75,40,22
 .BYT 32,8,62,39,51,70,18,25,31,85
 .BYT 41,96,49,88,17,80,61,2,34,15
 .BYT 69,94,43,77,83,7,30,26,60,66
 .BYT 44,67,52,74,1,28,53,13,72,86
 .BYT 5,97,48,12,24,14,79,71,46,45
 .BYT 0,55,89,16,91,98,54,73,63,95
 .BYT 33,93,35,3,68,21,65,37,56,57
 .BYT 92,20,87,4,11,90,23,76,59,38
 .BYT 36,58,81,6,42,10,84,78,29,99
.OPT LIS
.END
