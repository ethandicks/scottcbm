...
;;;*=$80F
 ...
 .HEX 0d 08 0a 00 9e 28 32 30 36 33 29 00 00 00
...
BL370
;
 JSR DB_ROOMN ; DEBUG Print room number
;
...
BL560
 ...
 LDY ROOMP+1,X
 STA INDEX1
 STY INDEX1+1 ;POINT TO DESCRIPTION
 LDX #0
...
BL640 LDA IL,X
 ...
 BNE BL670 ;NAH.
;
; INSTALL SCREEN WRAP CHECK HERE
;
 TXA
 ASL
 TAY
...
BL1530 ;INVENTORY
 PHY
 LDA #<NTHING ;ASSUME WE HAVE "NOTHING"
 STA KP
 LDY #>NTHING
 STY KP+1
 PRINT CARRY ;SAY "CARRYING:"
;
 LDX #0
IN000
 LDA IL,X ;GET ITEM LOC
 BPL IN001 ;HELD ITEMS IN -1
;
; INSTALL SCREEN WRAP CHECK HERE
;
 TXA
 ...
 LDA #SP
 JSR OUTCH ;PRINT DELIMTER
 LDA #<NTHEND ;PLAYER NOT CARRYING "NOTHING"
 STA KP
 LDY #>NTHEND
 STA KP
IN001 INX
 ...
 BCC IN000
;
 LDA KP ;GET CLOSING STRING POINTER
 LDY KP+1
 JSR STROUT ;PRINT "NOTHING" OR ""
 PLY
 GOTO 1610
;
BL1570 ;SET BIT 0
...
TRSRS  .BYTE " TREASURES. ",$CF,"N A SCALE"
       .BYTE CR,"OF 0 TO 100 THAT RATES A",0
DONE   .BYTE $D7,$C5,$CC,$CC,$20,$C4,$CF,$CE,$C5,CR,0
CARRY  .BYTE $C9,$27,$CD,$20,$C3,$C1,$D2,$D2,$D9,$C9,$CE,$C7,$3A,CR,0
NTHING .BYTE "NOTHING"
NTHEND .BYTE CR,0
SAVMSG .BYTE $D3,"AVE NOT IMPLEMENTED YET.",CR,0
;
; CALCULATION TABLES
;
...
KP     DS.B 2 ;STRING POINTER FOR NOTHING INVENTORY
;.OPT LIS
;.END
